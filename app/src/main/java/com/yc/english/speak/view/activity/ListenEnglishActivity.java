...
//        RxView.clicks(mPrev).throttleFirst(500, TimeUnit.MICROSECONDS).subscribe(new Action1<Void>() {
//            @Override
...
//        });
//
//        RxView.clicks(mNext).throttleFirst(500, TimeUnit.MICROSECONDS).subscribe(new Action1<Void>() {
//            @Override
//            public void call(Void aVoid) {
//                if (!getNextInfo()) {
//                    downAudioFile();
